...
/* harmony import */ var _modules_smooth_to_anchor__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/smooth-to-anchor */ "./js/modules/smooth-to-anchor.js");
/* harmony import */ var _modules_accordion_init_accordion__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/accordion/init-accordion */ "./js/modules/accordion/init-accordion.js");
/* harmony import */ var _modules_show_more_about__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/show-more-about */ "./js/modules/show-more-about.js");
/* harmony import */ var _utils_focus_lock__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./utils/focus-lock */ "./js/utils/focus-lock.js");
/* harmony import */ var _utils_scroll_lock__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./utils/scroll-lock */ "./js/utils/scroll-lock.js");
...
window.addEventListener('DOMContentLoaded', function () {
  window.scrollLock = new _utils_scroll_lock__WEBPACK_IMPORTED_MODULE_7__["ScrollLock"]();
  // Utils
  // ---------------------------------

  Object(_utils_ios_vh_fix__WEBPACK_IMPORTED_MODULE_0__["iosVhFix"])();
  Object(_modules_smooth_to_anchor__WEBPACK_IMPORTED_MODULE_3__["scrollSmooth"])();
  Object(_modules_show_more_about__WEBPACK_IMPORTED_MODULE_5__["showMore"])();
  Object(_modules_accordion_init_accordion__WEBPACK_IMPORTED_MODULE_4__["initAccordions"])();
  // Modules
  // ---------------------------------
  ...
  window.addEventListener('load', function () {
    ...
    window.focusLock = new _utils_focus_lock__WEBPACK_IMPORTED_MODULE_6__["FocusLock"]();
  ...
  if (!e.target.selectionStart) {
    setTimeout(function () {
      ...
      if (e.target.value.startsWith('+8')) {
        e.target.value = "+7".concat(e.target.value.slice(2));
        return;
      }
      e.target.value = '';
    });
...
var showMore = function showMore() {
  var showMoreButton = document.querySelector('.about__button');
  var aboutSection = document.querySelector('.about__wrapper');
  aboutSection.classList.remove('about__wrapper--no-js');
  var hideAddedText = function hideAddedText() {
  ...
  var onShowMoreButtonClick = function onShowMoreButtonClick() {
...
var scrollSmooth = function scrollSmooth() {
  ...
  document.querySelectorAll('a[href^="#"').forEach(function (link) {
    link.addEventListener('click', function (evt) {
      ...
      var topOffset = header.offsetHeight * GRADIENTHEIGHT;
